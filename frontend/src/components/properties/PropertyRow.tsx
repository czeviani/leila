    ...
    >
      ...
      <td className={`sticky right-0 z-10 whitespace-nowrap bg-inherit px-2 ${yPadding}`}>
        <div className="flex items-center justify-end gap-0.5">
          ...
          {(property.listing_url || property.edital_url) && <a href={property.listing_url || property.edital_url || '#'} target="_blank" rel="noopener noreferrer" onClick={event => event.stopPropagation()} aria-label="Abrir página oficial do imóvel" title="Abrir página oficial do imóvel" className="inline-block rounded-lg p-2 text-slate-400 transition hover:bg-white hover:text-[#176B87]"><ExternalLink size={15} /></a>}
